...
class UserProfileCreation extends React.Component {
  ...
  submit(data) {
    const { firstName, lastName, userEmail, userNumber, uhNumber, description } = data;
    const owner = Meteor.user().username;
    Users.insert({ firstName, lastName, userEmail, userNumber, uhNumber, description, owner }, this.insertCallback);
  }
